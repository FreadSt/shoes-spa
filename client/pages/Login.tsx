  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-md relative">
        ...
        <h2 className="text-2xl font-bold mb-6 text-center">Увійти</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-brand-orange text-white py-2 rounded-md font-semibold hover:bg-orange-600 transition-colors">Увійти</button>
        </form>
        <p className="mt-4 text-center text-sm text-gray-600">
          Немає аккаунта? <a href="/signup" className="text-brand-orange hover:underline">Зареєструватися</a>
        </p>
      </div>
    </div>
  );
